...
export function HowItWorksSection() {
  ...
  return (
    <section id="astrology" className="min-h-screen flex items-center justify-center relative overflow-hidden py-20">
      <ZodiacBackground />
        ...
        <div className="max-w-4xl mx-auto border-2 border-purple-300/40 rounded-lg p-8 md:p-12 relative backdrop-blur-sm bg-[#0f1433]/30">
          ...
          <div className="space-y-8">
            {steps.map((step, index) => (
              ...
              >
                <h3 className="text-xl text-amber-100 mb-3 tracking-wide" style={{ fontFamily: 'var(--font-elegant)' }}>
                  {step.title}
                </h3>
                <p className="text-amber-100/70 leading-relaxed text-sm" style={{ fontFamily: 'var(--font-sans)' }}>
                  {step.description}
                </p>
              </div>
            ))}
