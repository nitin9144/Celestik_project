...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="min-h-screen flex items-center justify-center relative overflow-hidden py-20">
      <ZodiacBackground />
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto border-2 border-purple-300/40 rounded-lg p-8 md:p-12 relative backdrop-blur-sm bg-[#0f1433]/30">
          ...
          <div className="text-center mb-8">
            <h2 className="text-4xl md:text-5xl text-amber-100 mb-3 drop-shadow-[0_0_20px_rgba(251,191,36,0.3)]" style={{ fontFamily: 'var(--font-serif)' }}>
              CONTACT US
            </h2>
            <p className="text-purple-200 text-sm" style={{ fontFamily: 'var(--font-mystical)' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="px-12 py-3 bg-amber-200 text-[#0f1433] hover:bg-amber-100 transition-all duration-300 tracking-wider hover:shadow-[0_0_20px_rgba(251,191,36,0.5)] hover:scale-105"
                style={{ fontFamily: 'var(--font-sans)' }}
              >
                SUBMIT NOW
              </button>
