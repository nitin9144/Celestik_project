        ...
        <div className="border-2 border-purple-300/40 rounded-lg p-8 md:p-12 relative backdrop-blur-sm bg-[#0f1433]/30">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="space-y-2">
              ...
              <p className="text-right text-amber-100/60 text-sm" style={{ fontFamily: 'var(--font-mystical)' }}>
                  ...
                  <div className="relative w-8 h-8 flex-shrink-0">
                    {step.completed ? (
                      ...
                      <div className="w-8 h-8 rounded-full border-2 border-purple-300/40 flex items-center justify-center">
                        <span className="text-xs text-purple-300/60">{index + 1}</span>
                      </div>
                    )}
                  </div>
            ...
            <div className="text-center space-y-4">
              <div className="flex justify-center gap-2">
                ...
                <div className="w-2 h-2 rounded-full bg-purple-300 animate-pulse" style={{ animationDelay: '0.3s' }} />
                <div className="w-2 h-2 rounded-full bg-amber-200 animate-pulse" style={{ animationDelay: '0.6s' }} />
              </div>
              <p className="text-purple-300/80 text-sm italic" style={{ fontFamily: 'var(--font-mystical)' }}>
                Connecting with the cosmic threads...
              </p>
            </div>
            ...
            <div className="bg-[#1a2555]/40 border border-purple-300/20 rounded p-4 text-center">
              <p className="text-purple-300/80 text-xs" style={{ fontFamily: 'var(--font-elegant)' }}>
                ✨ We're decoding the ancient language in your palm using modern AI
              </p>
            </div>
          </div>
        </div>
