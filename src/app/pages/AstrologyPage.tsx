        ...
        <div className="max-w-3xl mx-auto border-2 border-purple-300/40 rounded-lg p-12 md:p-16 relative text-center backdrop-blur-sm bg-[#0f1433]/30">
          ...
          <div className="space-y-8">
            <div className="flex justify-center gap-6 mb-8">
              ...
              <Star className="w-16 h-16 text-purple-300 animate-pulse" style={{ animationDelay: '1s' }} />
            </div>

            <div>
              <h1 className="text-5xl md:text-6xl text-amber-100 mb-4 drop-shadow-[0_0_30px_rgba(251,191,36,0.4)]" style={{ fontFamily: 'var(--font-serif)' }}>
                ASTROLOGY
              </h1>
            ...
            <div className="space-y-4">
              <h2 className="text-3xl md:text-4xl text-purple-200" style={{ fontFamily: 'var(--font-mystical)' }}>
                Coming Soon
              </h2>
              ...
              <p className="text-purple-200/70" style={{ fontFamily: 'var(--font-sans)' }}>
                Our astrology feature is being crafted with the precision of the cosmos. Stay tuned as we prepare to unlock the secrets written in your stars.
              </p>
            </div>
            ...
            <div className="pt-8">
              ...
              >
                <span className="tracking-wider">TRY PALMISTRY INSTEAD</span>
              </button>
            </div>
          </div>
        </div>
