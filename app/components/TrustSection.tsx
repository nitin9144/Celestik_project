  ...
  const trustPoints = [
    {
      ...
      description:
        "₹1 verification payment processed securely. Your financial data is encrypted and protected.",
    },
    {
      icon: Database,
      title: "Private Data",
      description:
        "Your palm image and personal information are never shared. Your privacy is sacred.",
    },
    {
      icon: Shield,
      title: "No Future Predictions",
      description:
        "We decode patterns, not destiny. Our insights empower, never limit your choices.",
    },
  ];
    ...
    <section className="relative py-20 px-4 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <p
            className="text-purple-200 italic max-w-2xl mx-auto"
          ...
          {trustPoints.map((point, index) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <h3
                    className="text-amber-100 font-semibold tracking-wide mb-2"
                    style={{ fontFamily: "var(--font-mystical)" }}
                  >
                    {point.title}
                  </h3>
        ...
        <div className="mt-12 text-center">
          <div className="inline-block bg-[#1a2555]/40 border border-purple-300/40 rounded-full px-6 py-3">
            <p
              className="text-purple-200/80 text-sm italic"
              style={{ fontFamily: "var(--font-elegant)" }}
            >
              🔒 Built with integrity • Designed for empowerment • Trusted by
              thousands
            </p>
          </div>
        </div>
