  ...
  const steps = [
    {
      ...
      description:
        "Share a clear photo of your palm. Our sophisticated algorithms begin their cosmic analysis.",
      icon: Sparkles,
    },
    {
      number: "2",
      ...
      description:
        "Our advanced AI decodes the ancient language of palmistry using modern machine learning.",
      icon: Zap,
    },
    {
      number: "3",
      ...
      description:
        "Get personalized insights about your personality, emotions, and life path in seconds.",
      icon: Sparkles,
    },
  ];
