      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-12 space-y-4">
          <div className="flex justify-center gap-2">
            ...
            <Sparkles
              className="w-8 h-8 text-purple-300 animate-bounce"
              style={{ animationDelay: "0.3s" }}
            />
          </div>
          <h3
            className="text-2xl md:text-3xl text-purple-200 italic"
          ...
          <div className="relative border-2 border-purple-300/40 rounded-lg p-8 md:p-12 backdrop-blur-sm bg-gradient-to-br from-purple-900/30 to-amber-900/20 space-y-6">
            ...
            <div className="relative z-10 space-y-6 text-center">
              ...
              <div className="space-y-3">
                ...
                >
                  Discover the cosmic blueprint written in the stars at your
                  birth.
                </p>
                <div
                  className="space-y-2 text-purple-200/80 text-sm"
                  style={{ fontFamily: "var(--font-elegant)" }}
                >
              ...
              {/* Tagline */}
              <p
                className="text-purple-300/60 text-xs italic"
                style={{ fontFamily: "var(--font-mystical)" }}
              >
