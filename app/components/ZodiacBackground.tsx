          ...
          {zodiacSymbols.map((symbol, i) => (
            <div
              ...
              style={{
                ...
                animation: animate
                  ? `float ${8 + i * 1}s infinite ease-in-out`
                  : "none",
