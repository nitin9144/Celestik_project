  ...
  return (
    <footer className="relative bg-[#0f1433] border-t border-purple-900/30 py-12">
      <div className="container mx-auto px-4">
        {isContactPage && (
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <h3
                  className="text-3xl text-amber-100 tracking-wider mb-2"
                  style={{ fontFamily: "var(--font-serif)" }}
                >
                  CELESTIK
                </h3>
                <p
                  className="text-purple-200 text-sm italic mb-1"
                ...
                >
                  Guiding through the cosmic hidden in your palm. Ancient
                  intuition meets modern tech.
                </p>
              </div>
            </div>
        ...
        {/* Copyright */}
        <div
          className={`pt-6 border-t border-purple-900/30 text-center ${
            isContactPage ? "mt-8" : ""
          }`}
        >
          <p
          ...
          <p
            className="text-purple-300/60 text-xs mt-1"
            style={{ fontFamily: "var(--font-sans)" }}
          >
