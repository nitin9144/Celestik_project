        ...
        <div className="mx-auto border-2 border-purple-300/40 rounded-lg p-8 md:p-16 lg:p-20 relative backdrop-blur-sm bg-[#0f1433]/30">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              ...
              <p
                className="text-amber-100/80 leading-relaxed text-justify"
                style={{ fontFamily: "var(--font-elegant)" }}
              >
                For centuries your palm has whispered secrets about your
                purpose, potential and personality. We've simply reimagined the
                ancient art of palmistry for the modern world.
              </p>

              <div className="space-y-3">
                <button
                  onClick={() => router.push("/reveal-cosmic-truth")}
                ...
                <p
                  ...
                  style={{ fontFamily: "var(--font-elegant)" }}
                >
                  Upload your palm. Let the stars speak — beautifully,
                  digitally, and just for you.
                </p>
              </div>
            </div>
